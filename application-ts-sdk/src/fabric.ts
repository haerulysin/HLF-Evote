...
import { Wallet, Contract, Wallets, Gateway, GatewayOptions, DefaultEventHandlerStrategies, DefaultQueryHandlerStrategies, Network, Transaction, Identity } from 'fabric-network';
...
export const createWallet = async (
    ...
    const uid = createHash('sha256').update(JSON.stringify(identity)).digest('hex');
